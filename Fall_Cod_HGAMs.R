...
# current model:
# sort(c('SURFTEMP','ctyp_100m3','sand_pct','BOTTEMP','DEPTH','Stg','chl4','grnszmm','chl2','chl10'))
# [1] "BOTTEMP"    "chl10"      "chl2"       "chl4"       "ctyp_100m3" "DEPTH"      "grnszmm"    "sand_pct"  
# [9] "Stg"        "SURFTEMP"  



### UPDATE DATA to remove ichtyhyoplankton for fall Cod (only 6 positive samples 1977-2017)
