...
save(zoo_modG_pa, file='/home/ryan/Git/NEhabitat/rasters/Spr/zoop/zoo_modG_pa_spr_pseudocal.Rdata')
save(zoo_modG_pb, file='/home/ryan/Git/NEhabitat/rasters/Spr/zoop/zoo_modG_pb_spr_pseudocal.Rdata')
...
save(zoo_modG4_pa, file='/home/ryan/Git/NEhabitat/rasters/Spr/zoop/zoo_modG4_pa_spr_pseudocal.Rdata')
save(zoo_modG4_pb, file='/home/ryan/Git/NEhabitat/rasters/Spr/zoop/zoo_modG4_pb_spr_pseudocal.Rdata')
...
save(zoo_modG4bll_pa, file='/home/ryan/Git/NEhabitat/rasters/Spr/zoop/zoo_modG4bll_pa_spr_pseudocal.Rdata')
save(zoo_modG4bll_pb, file='/home/ryan/Git/NEhabitat/rasters/Spr/zoop/zoo_modG4bll_pb_spr_pseudocal.Rdata')
...
```{r}
### select data
fish.b=FData.bio %>% dplyr::select(YEAR, SEASON, LAT:BOTTEMP, `74_Adt`, `74_Juv`, `74_ich`, calfin_100m3:rug)
...
fish_modG_pb = gam(pa ~ s(BOTTEMP, k=20, bs="tp") +s(SURFTEMP, k=20, bs='tp') + s(DEPTH, k=10, bs="tp") + s(Stg, k=3, bs='re') + s(pseudo_100m3, k=20, bs="cr") + s(grnszmm, k=10, bs='tp') + s(rug, k=20, bs='tp'), data=trainBIO, method = "REML", family="gaussian")

# save(fish_modG_pa, file='/home/ryan/Git/NEhabitat/rasters/Spr/Haddock/fish_modG_pa_spr_haddock.Rdata')
# save(fish_modG_pa, file='/home/ryan/Git/NEhabitat/rasters/Fall/Haddock/fish_modG_pa_fall_haddock.Rdata')
# save(fish_modG_pb, file='/home/ryan/Git/NEhabitat/rasters/Spr/Haddock/fish_modG_pb_spr_haddock.Rdata')
# save(fish_modG_pb, file='/home/ryan/Git/NEhabitat/rasters/Fall/Haddock/fish_modG_pb_fall_haddock.Rdata')
par(mfrow=c(2,2))
gam.check(fish_modG)
plot(fish_modG, shade=T, rug=T, scale=0)
AIC(fish_modG)
...
fish_modG4_pb = gam(pa ~ s(LON, LAT) + s(BOTTEMP, k=20, bs="tp") +s(SURFTEMP, k=20, bs='tp') + s(DEPTH, k=10, bs="tp") + s(Stg, k=4, bs='re') + s(pseudo_100m3, k=20, bs="cr") + s(grnszmm, k=10, bs='tp') + s(rug, k=20, bs='tp'), data=trainBIO, method = "REML", family="gaussian")

# save(fish_modG4, file='/home/ryan/Git/NEhabitat/rasters/Spr/Haddock/fish_modG4_spr_haddock.Rdata')
# save(fish_modG4, file='/home/ryan/Git/NEhabitat/rasters/Fall/Haddock/fish_modG4_fall_haddock.Rdata')
...
fish_modG4bll_pb = gam(pa ~ s(LON, LAT, bs = "so", xt = list(bnd = boundll)) + s(BOTTEMP, k=20, bs="tp") +s(SURFTEMP, k=20, bs='tp') + s(DEPTH, k=10, bs="tp") + s(Stg, k=4, bs='fs') + s(pseudo_100m3, k=20, bs="cr") + s(grnszmm, k=10, bs='tp') + s(rug, k=20, bs='tp'), data=trainBIO.sub, method = "REML", knots=knotsll, family="gaussian")

# save(fish_modG4bll_pa, file='/home/ryan/Git/NEhabitat/rasters/Spr/Haddock/fish_modG4bll_pa_spr_haddock.Rdata')
# save(fish_modG4bll_pa, file='/home/ryan/Git/NEhabitat/rasters/Fall/Haddock/fish_modG4bll_pa_fall_haddock.Rdata')
# save(fish_modG4bll_pb, file='/home/ryan/Git/NEhabitat/rasters/Spr/Haddock/fish_modG4bll_pb_spr_haddock.Rdata')
# save(fish_modG4bll_pb, file='/home/ryan/Git/NEhabitat/rasters/Fall/Haddock/fish_modG4bll_pb_fall_haddock.Rdata')
...
fish_modGSe_pb =  gam(pa ~ s(BOTTEMP, bs='tp') + s(BOTTEMP, Stg, k=10, bs="fs") + s(SURFTEMP, bs='tp') + s(SURFTEMP, Stg, k=10, bs='fs') + s(DEPTH, bs='tp') + s(DEPTH, Stg, k=10, bs="fs") + s(pseudo_100m3, bs='tp') + s(pseudo_100m3, Stg, k=10, bs="fs") + s(grnszmm, bs='tp') + s(grnszmm, Stg, k=10, bs='fs') + s(rug, bs='tp') + s(rug, Stg, k=10, bs='fs'), data=trainBIO, method = "REML", family="gaussian")

# save(fish_modGSe_pa, file='/home/ryan/Git/NEhabitat/rasters/Spr/Haddock/fish_modGSe_pa_spr_haddock.Rdata')
# save(fish_modGSe_pa, file='/home/ryan/Git/NEhabitat/rasters/Fall/Haddock/fish_modGSe_pa_fall_haddock.Rdata')
# save(fish_modGSe_pb, file='/home/ryan/Git/NEhabitat/rasters/Spr/Haddock/fish_modGSe_pb_spr_haddock.Rdata')
# save(fish_modGSe_pb, file='/home/ryan/Git/NEhabitat/rasters/Fall/Haddock/fish_modGSe_pb_fall_haddock.Rdata')
...
fish_modGI_pb =  gam(pa ~ s(BOTTEMP, k=10, m=2, bs="tp") + s(BOTTEMP, k=10, m=1, by=Stg, bs="tp") +s(SURFTEMP, k=10, m=2, bs='tp') + s(SURFTEMP, by=Stg, k=10, m=1, bs='tp') + s(DEPTH, k=10, m=2, bs="tp") + s(DEPTH, by=Stg, k=10, m=1, bs="tp") + s(pseudo_100m3, k=10, m=2, bs="tp") + s(pseudo_100m3, m=1, k=10, by=Stg, bs="tp")+ s(grnszmm, m=2, k=10, bs='tp') + s(grnszmm, by=Stg, k=10, m=1, bs='tp') + s(rug, m=2, k=10, bs='tp') +s(rug, by=Stg, k=10, m=1, bs='tp') + s(Stg, k=10, bs='re'), data=trainBIO, method = "REML", family="gaussian")

# save(fish_modGI_pa, file='/home/ryan/Git/NEhabitat/rasters/Spr/Haddock/fish_modGI_pa_spr_haddock.Rdata')
# save(fish_modGI_pa, file='/home/ryan/Git/NEhabitat/rasters/Fall/Haddock/fish_modGI_pa_fall_haddock.Rdata')
# save(fish_modGI_pb, file='/home/ryan/Git/NEhabitat/rasters/Spr/Haddock/fish_modGI_pb_spr_haddock.Rdata')
# save(fish_modGI_pb, file='/home/ryan/Git/NEhabitat/rasters/Fall/Haddock/fish_modGI_pb_fall_haddock.Rdata')
...
fish_modS_pb =  gam(pa ~ s(BOTTEMP, Stg, k=10, bs="fs") + s(SURFTEMP, Stg, k=10, bs='fs') + s(DEPTH, Stg, k=10, bs="fs") + s(pseudo_100m3, Stg, k=10, bs="fs") + s(grnszmm, Stg, k=10, bs='fs') + s(rug, Stg, k=10, bs='fs'), data=trainBIO, method = "REML", family="gaussian")


# save(fish_modS_pa, file='/home/ryan/Git/NEhabitat/rasters/Spr/Haddock/fish_modS_pa_spr_haddock.Rdata')
# save(fish_modS_pa, file='/home/ryan/Git/NEhabitat/rasters/Fall/Haddock/fish_modS_pa_fall_haddock.Rdata')
# save(fish_modS_pb, file='/home/ryan/Git/NEhabitat/rasters/Spr/Haddock/fish_modS_pb_spr_haddock.Rdata')
# save(fish_modS_pb, file='/home/ryan/Git/NEhabitat/rasters/Fall/Haddock/fish_modS_pb_fall_haddock.Rdata')
```
...
fish_modI_pb =  gam(pa ~ Stg + s(BOTTEMP, by=Stg, k=10, bs="tp") + s(SURFTEMP, by=Stg, k=10, bs='tp') + s(DEPTH, by=Stg, k=10, bs="tp") + s(pseudo_100m3, by=Stg, k=10, bs="tp") + s(grnszmm, by=Stg, k=10, bs='tp') + s(rug, by=Stg, k=10, bs='tp'), data=trainBIO, method = "REML", family="gaussian")

# save(fish_modI_pa, file='/home/ryan/Git/NEhabitat/rasters/Spr/Haddock/fish_modI_pa_spr_haddock.Rdata')
# save(fish_modI_pa, file='/home/ryan/Git/NEhabitat/rasters/Fall/Haddock/fish_modI_pa_fall_haddock.Rdata')
# save(fish_modI_pb, file='/home/ryan/Git/NEhabitat/rasters/Spr/Haddock/fish_modI_pb_spr_haddock.Rdata')
# save(fish_modI_pb, file='/home/ryan/Git/NEhabitat/rasters/Fall/Haddock/fish_modI_pb_fall_haddock.Rdata')
```
